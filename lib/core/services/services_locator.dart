...
import '../../pagination/domain/usecase/add_menu_usecase.dart';
import '../../pagination/ui/bloc/add_menu_bloc.dart';
...
class AppServiceLocator {
  static Future<void> initAppServiceLocator() async {
    ...
    appServiceLocator
        .registerFactory<AddMenuBloc>(() => AddMenuBloc(appServiceLocator()));

    appServiceLocator.registerLazySingleton<GetDataUseCase>(
        () => GetDataUseCase(baseRepo: appServiceLocator()));

    appServiceLocator.registerLazySingleton<AddNewMenuUseCase>(
        () => AddNewMenuUseCase(baseRepo: appServiceLocator()));
